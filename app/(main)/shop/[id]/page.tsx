        ...
        <div className="flex flex-col p-4 sm:p-8">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-black tracking-tight text-brown">
                {product.name}
              </h1>
            </div>
          ...
          <div className="mt-6 rounded-3xl bg-amber-50 p-5">
            <p className="text-xs text-muted">兑换需要</p>
            <Coin value={product.price} className="mt-1 text-3xl" />
          ...
          <div className="mt-auto pt-7">
            <div className="mb-4 flex items-center justify-between text-sm">
              <span className="text-muted">你的可用奶龙币</span>
              <Coin value={balance} />
            </div>
            {canRedeem ? (
